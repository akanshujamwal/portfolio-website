import { useAbout, useProfile, useContact } from "../../../core/firebase/useFirestore";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-gradient-to-br from-indigo-600/20 to-purple-600/10 border border-indigo-500/20 rounded-2xl p-8 sm:p-10 text-center">
            ...
            {cvUrl ? (
              ...
              <span className="inline-flex items-center gap-2 bg-indigo-600/40 text-white/60 font-semibold px-8 py-3 rounded-lg cursor-not-allowed">
                CV Coming Soon
              </span>
            )}
            {meetingLink && (
