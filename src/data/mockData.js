  ...
  values: [
    {
      ...
      description:
        "I write code that the next developer (or future me) can understand without a manual. Simple and readable always wins.",
    },
    {
      icon: "🏗️",
      title: "Architecture First",
      description:
        "Before writing code, I think about structure. A well-designed system is easier to build, easier to debug, and easier to scale.",
    },
    {
      icon: "🚀",
      title: "Ship, Then Improve",
      description:
        "I believe in getting things in front of users quickly and iterating based on real feedback, rather than perfecting in isolation.",
    },
    {
      icon: "📖",
      title: "Always Learning",
      description:
        "The tech world moves fast. I dedicate time every week to learning something new — whether it's a tool, a pattern, or a concept.",
    },
  ],
};
...
export const experiencesData = [
  {
    ...
    endYear: null,
    description:
      "Leading frontend development for the company's SaaS dashboard product. Built reusable component libraries, improved Lighthouse scores by 40%, and mentored two junior developers.",
    order: 1,
  },
  {
    id: 2,
    ...
    endYear: "Dec 2024",
    description:
      "Developed and shipped a customer-facing web app from scratch using React and Firebase. Worked directly with the CTO to define architecture and deliver features on a tight deadline.",
    order: 2,
  },
  {
    id: 3,
    ...
    endYear: "May 2024",
    description:
      "Worked with multiple small businesses to build and maintain websites. Delivered 8+ projects including e-commerce stores, landing pages, and portfolio websites.",
    order: 3,
  },
];
...
export const educationData = [
  {
    ...
    endYear: "2023",
    description:
      "Focused on data structures, algorithms, and software engineering fundamentals. Built a final year project — a real-time collaborative coding platform.",
    order: 1,
  },
  {
    id: 2,
    school: "freeCodeCamp & Self Study",
    ...
    endYear: "2022",
    description:
      "Completed 300+ hours of hands-on web development training covering responsive design, JavaScript algorithms, React, and APIs.",
    order: 2,
  },
];
